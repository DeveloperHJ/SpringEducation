...
<div class="container">
  <div class="nav-wrapper">
    ...
    <ul class="right hide-on-med-and-down">
  	...
  	<c:choose>
  		<c:when test="${login.id eq null}">
      		<li id="loginOn"><a href="/login/loginIn"><span class="grey-text text-darken-3">로그인</span></a></li>
        </c:when>
    	<c:otherwise>
 	   	 	<li id="myModify"><a href="/member/memberList"><span class="grey-text text-darken-3">회원목록</span></a></li>
    	    <li id="myModify"><a href="/member/memberModify/${login.id}"><span class="grey-text text-darken-3">내정보</span></a></li>
    ...
    <c:choose>
  		<c:when test="${login.id eq null}">
	    	<li><a href="/login/loginIn"><span class="grey-text text-darken-3">로그인</span></a></li>
	    </c:when>
    	<c:otherwise>
    		<li id="myModify"><a href="/member/memberList"><span class="grey-text text-darken-3">회원목록</span></a></li>
    	    <li id="myModify"><a href="/member/memberModify/${login.id}"><span class="grey-text text-darken-3">내정보</span></a></li>
