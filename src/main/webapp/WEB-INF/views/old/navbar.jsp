...
<nav class="navbar navbar-toggleable-md mb-4 top-bar navbar-static-top sps sps--abv">
  ...
  <a class="navbar-brand" href="#">Burn<span>out</span></a>
  <div class="collapse navbar-collapse" id="navbarCollapse1">
    <ul class="navbar-nav ml-auto">
     <li class="nav-item active"> <a class="nav-link" href="/">Home <span class="sr-only">(current)</span></a> </li>
    <li class="nav-item"> <a class="nav-link" href="/bbs/list">게시판</a> </li>
    <li class="nav-item"> <a class="nav-link" href="/login/login">로그인</a> </li>
    <li class="nav-item"> <a class="nav-link" href="/member/memberJoin">회원가입</a> </li>
    <li class="nav-item"> <a class="nav-link" href="/member/memberList">회원목록</a> </li>
