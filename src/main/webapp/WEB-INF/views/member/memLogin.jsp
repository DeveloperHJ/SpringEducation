...
<link href="//SpringEdu/src/main/webapp/WEB-INF/views/member/memStyle.css" rel="stylesheet">
    ...
    <h1 class="welcome text-center">Welcome!</h1>
        ...
        <hr>
            ...
            <form class="form-signin">
                ...
                <input type="text" id="inputEmail" class="login_box" placeholder="userID@userEmail.com" required autofocus>
                <p class="input_title">Password</p>
                <input type="password" id="inputPassword" class="login_box" placeholder="password" required>
